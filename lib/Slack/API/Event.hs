...
data Event where
  ...
  FileChange  :: FileId -> SlackTimeStamp -> Event
...
parseType o@(Object v) typ = case typ of
  "hello"            -> return Hello
  "message" -> do
    subt <- (\case
  ...
  "file_shared"  -> FileShared <$> v .: "file_id"
  "file_unshared" -> FileUnshared <$> v .: "file_id"
  "file_public"  -> FilePublic <$> v .: "file_id"
  "file_private" -> FilePrivate <$> v .: "file_id"
  "file_change"  -> FileChange <$> v .: "file_id" <*> v .: "event_ts"
...
data Submitter = UserComment UserId
               | BotComment BotId
               | System
               deriving (Show, Eq)
...
instance FromJSON ChannelRenameInfo where
  parseJSON = withObject "ChannelRenameInfo" (\o ->
    ChannelRenameInfo
      <$> o .: "id"
      <*> o .: "name"
      <*> o .: "created")
