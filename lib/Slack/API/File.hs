...
instance FromJSON File where
  parseJSON = withObject "File" (\o ->
    File
      ...
      <*> o .: "external_type"
      <*> o .: "size"
      <*> (parseJSON (Object o) :: Parser FileUrl)
      <*> (parseJSON (Object o) :: Parser Thumbnail)
      <*> o .: "permalink"
      <*> o .:? "edit_link"
      ...
      <*> o .: "groups"
      <*> o .:? "initial_comment"
      <*> fmap (fromMaybe 0) (o .:? "num_stars")
      <*> o .: "comments_count")

instance FromJSON FileUrl where
  parseJSON = withObject "FileURL" (\o ->
    FileURL
      <$> o .: "url_private"
...
instance FromJSON Preview where
  parseJSON = withObject "preview" (\o ->
    Preview
      <$> o .: "preview"
      <*> o .: "preview_highlight"
      <*> o .: "lines"
