...
subtype s = withObject "subtype" (\v -> case s of
  "bot_message"       -> SBotMessage <$> v .: "bot_id"
                                     <*> v .:? "username"
                                     <*> v .:? "icons"
  ...
  "channel_name"      -> SChannelName <$> v .: "old_name"
                                      <*> v .: "name"
